...
contract DcrnSwapAssetV2 is ERC20, ERC20Detailed {
   ...
   function maxSwapOutValue() public view returns (uint256) {
    ...
    function initOwner(address newOwner) public onlyOwner returns (bool) {
    ...
    function changeOwner(address newOwner) public onlyOwner returns (bool) {
        ...
        _oldOwner = owner();
        _newOwner = newOwner;
        _newOwnerEffectiveHeight = block.number + 10;
        emit LogChangeOwner(_oldOwner, _newOwner, _newOwnerEffectiveHeight);
        return true;
    }
